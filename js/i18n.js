(function () {
  ...
  const translations = {
    ...
    'Subaru, KGM, Jeep a Chery v PP AUTO Poprad. Skladové vozidlá, konfigurácia a nezáväzná online objednávková požiadavka, financovanie a servis.': 'Subaru, KGM, Jeep and Chery at PP AUTO Poprad. Stock vehicles, custom configurations, non-binding online order requests, financing and service.',
    ...
    'Novinka v PP AUTO': 'New at PP AUTO',
    'Vaše nové auto': 'Your New Car',
    'začína online.': 'Starts Online.',
    'Skladové vozidlo si vyberiete hneď, vlastnú konfiguráciu si vyskladáte podľa seba. Pošlite nezáväznú požiadavku a náš predajca sa postará o ďalší krok.': 'Choose a stock vehicle right away or build a configuration around your needs. Send a non-binding request and our sales advisor will take care of the next step.',
    'Výhody online objednávky': 'Online Order Benefits',
    'Bez platby online': 'No Online Payment',
    'Nezáväzne': 'No Commitment',
    'Osobné potvrdenie predajcom': 'Personally Confirmed by a Sales Advisor',
    'Začať online výber': 'Start Your Online Selection',
    'Dostupnosť, cenu a ďalší postup vám vždy potvrdí predajca.': 'A sales advisor will always confirm availability, price and the next steps.',
    'Online objednávka': 'Online Order',
    'Vybrané vozidlo': 'Selected Vehicle',
    'Auto podľa vašich predstáv': 'A Car Built Around You',
    'Skladové vozidlo': 'Stock Vehicle',
    'Vlastná konfigurácia': 'Custom Configuration',
    'Požiadavka bez platby': 'No-Payment Request',
    'Nezáväzný začiatok objednávky': 'A Non-Binding Start to Your Order',
    'Značky na výber': 'Brands to Choose From',
    'Ako funguje online objednávka': 'How Online Ordering Works',
    'Vyberte si auto': 'Choose Your Car',
    'Zo skladu alebo si nastavte vlastnú konfiguráciu.': 'Pick from stock or create your own configuration.',
    'Doplňte predstavu': 'Tell Us What You Need',
    'Výbava, financovanie, protiúčet a preferovaný termín.': 'Equipment, financing, trade-in and preferred delivery time.',
    'Predajca sa vám ozve': 'A Sales Advisor Will Contact You',
    'Potvrdí dostupnosť, cenu a dohodne ďalší postup.': 'They will confirm availability, price and agree on the next steps.',
